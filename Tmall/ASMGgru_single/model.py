...
class ASMGrnnSingle(object):
    ...
    def __init__(self, cates, cate_lens, hyperparams, emb_ls_dict, mlp_ls_dict, init_h_dict, train_config=None):
        ...
        with tf.variable_scope('meta_emb'):
            ...
            self.cate_emb_w_hs, cate_emb_w = rnn_combine(name='cate_emb_w',
    ...
    def get_h_dict(self, sess):
        user_emb_w_hs, item_emb_w_hs, cate_emb_w_hs, \
        fcn1_kernel_hs, fcn1_bias_hs, fcn2_kernel_hs, fcn2_bias_hs, \
        fcn3_kernel_hs, fcn3_bias_hs = sess.run([
            self.user_emb_w_hs, self.item_emb_w_hs, self.cate_emb_w_hs,
