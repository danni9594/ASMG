...
class ASMGlinear(object):
    ...
    def __init__(self, hyperparams, emb_ls_dict, mlp_ls_dict, train_config=None):
    ...
    def train_meta(self, sess, batch, batch_id):
        loss, _, user_emb_w_w, item_emb_w_w, \
        fcn1_kernel_w, fcn1_bias_w, fcn2_kernel_w, fcn2_bias_w, \
        fcn3_kernel_w, fcn3_bias_w = sess.run([
            self.loss, self.train_meta_op, self.user_emb_w_w, self.item_emb_w_w,
