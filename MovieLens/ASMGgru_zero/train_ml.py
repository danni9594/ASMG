...
train_config = {'method': 'ASMGgru_zero_by_period',
                'dir_name': 'ASMGgru_zero_linear_train11-23_test24-30_4emb_4mlp_1epoch',  # edit method to compute loss weight, train test period, rnn hidden size for emb and mlp, number of epochs
