...
train_config = {'method': 'ASMGlinear_by_period',
                'dir_name': 'ASMGlinear_train11-23_test24-30_1epoch',  # edit train test period, number of epochs
...
for seq_length in [3]:
    ...
    for meta_lr in [1e-2]:
        ...
        for i in range(start_period, train_config['num_periods']):
            ...
            asmg_model = ASMGlinear(cates, cate_lens, EmbMLP_hyperparams, emb_ls_dict, mlp_ls_dict, train_config=train_config)
